...
namespace Steamworks
{
	internal unsafe partial struct ISteamUserStats
	{
		...
		private static extern bool _SteamAPI_ISteamUserStats_GetStatInt32( IntPtr self, IntPtr pchName, ref int pData );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_GetStatFloat( IntPtr self, IntPtr pchName, ref float pData );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_SetStatInt32( IntPtr self, IntPtr pchName, int nData );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_SetStatFloat( IntPtr self, IntPtr pchName, float fData );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_UpdateAvgRateStat( IntPtr self, IntPtr pchName, float flCountThisSession, double dSessionLength );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_GetAchievement( IntPtr self, IntPtr pchName, [ MarshalAs( UnmanagedType.U1 ) ] ref bool pbAchieved );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_SetAchievement( IntPtr self, IntPtr pchName );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_ClearAchievement( IntPtr self, IntPtr pchName );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_GetAchievementAndUnlockTime( IntPtr self, IntPtr pchName, [ MarshalAs( UnmanagedType.U1 ) ] ref bool pbAchieved, ref uint punUnlockTime );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_StoreStats( IntPtr self );
		#endregion
		...
		private static extern int _SteamAPI_ISteamUserStats_GetAchievementIcon( IntPtr self, IntPtr pchName );
		#endregion
		...
		private static extern Utf8StringPtr _SteamAPI_ISteamUserStats_GetAchievementDisplayAttribute( IntPtr self, IntPtr pchName, IntPtr pchKey );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_IndicateAchievementProgress( IntPtr self, IntPtr pchName, uint nCurProgress, uint nMaxProgress );
		#endregion
		...
		private static extern uint _SteamAPI_ISteamUserStats_GetNumAchievements( IntPtr self );
		#endregion
		...
		private static extern Utf8StringPtr _SteamAPI_ISteamUserStats_GetAchievementName( IntPtr self, uint iAchievement );
		#endregion
		...
		private static extern SteamAPICall_t _SteamAPI_ISteamUserStats_RequestUserStats( IntPtr self, SteamId steamIDUser );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_GetUserStatInt32( IntPtr self, SteamId steamIDUser, IntPtr pchName, ref int pData );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_GetUserStatFloat( IntPtr self, SteamId steamIDUser, IntPtr pchName, ref float pData );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_GetUserAchievement( IntPtr self, SteamId steamIDUser, IntPtr pchName, [ MarshalAs( UnmanagedType.U1 ) ] ref bool pbAchieved );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_GetUserAchievementAndUnlockTime( IntPtr self, SteamId steamIDUser, IntPtr pchName, [ MarshalAs( UnmanagedType.U1 ) ] ref bool pbAchieved, ref uint punUnlockTime );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_ResetAllStats( IntPtr self, [ MarshalAs( UnmanagedType.U1 ) ] bool bAchievementsToo );
		#endregion
		...
		private static extern SteamAPICall_t _SteamAPI_ISteamUserStats_FindOrCreateLeaderboard( IntPtr self, IntPtr pchLeaderboardName, ELeaderboardSortMethod eLeaderboardSortMethod, ELeaderboardDisplayType eLeaderboardDisplayType );
		#endregion
		...
		private static extern SteamAPICall_t _SteamAPI_ISteamUserStats_FindLeaderboard( IntPtr self, IntPtr pchLeaderboardName );
		#endregion
		...
		private static extern Utf8StringPtr _SteamAPI_ISteamUserStats_GetLeaderboardName( IntPtr self, SteamLeaderboard_t hSteamLeaderboard );
		#endregion
		...
		private static extern int _SteamAPI_ISteamUserStats_GetLeaderboardEntryCount( IntPtr self, SteamLeaderboard_t hSteamLeaderboard );
		#endregion
		...
		private static extern ELeaderboardSortMethod _SteamAPI_ISteamUserStats_GetLeaderboardSortMethod( IntPtr self, SteamLeaderboard_t hSteamLeaderboard );
		#endregion
		...
		private static extern ELeaderboardDisplayType _SteamAPI_ISteamUserStats_GetLeaderboardDisplayType( IntPtr self, SteamLeaderboard_t hSteamLeaderboard );
		#endregion
		...
		private static extern SteamAPICall_t _SteamAPI_ISteamUserStats_DownloadLeaderboardEntries( IntPtr self, SteamLeaderboard_t hSteamLeaderboard, ELeaderboardDataRequest eLeaderboardDataRequest, int nRangeStart, int nRangeEnd );
		#endregion
		...
		private static extern SteamAPICall_t _SteamAPI_ISteamUserStats_DownloadLeaderboardEntriesForUsers( IntPtr self, SteamLeaderboard_t hSteamLeaderboard, SteamId* prgUsers, int cUsers );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_GetDownloadedLeaderboardEntry( IntPtr self, SteamLeaderboardEntries_t hSteamLeaderboardEntries, int index, ref LeaderboardEntry_t pLeaderboardEntry, int* pDetails, int cDetailsMax );
		#endregion
		...
		private static extern SteamAPICall_t _SteamAPI_ISteamUserStats_UploadLeaderboardScore( IntPtr self, SteamLeaderboard_t hSteamLeaderboard, ELeaderboardUploadScoreMethod eLeaderboardUploadScoreMethod, int nScore, int* pScoreDetails, int cScoreDetailsCount );
		#endregion
		...
		private static extern SteamAPICall_t _SteamAPI_ISteamUserStats_AttachLeaderboardUGC( IntPtr self, SteamLeaderboard_t hSteamLeaderboard, UGCHandle_t hUGC );
		#endregion
		...
		private static extern SteamAPICall_t _SteamAPI_ISteamUserStats_GetNumberOfCurrentPlayers( IntPtr self );
		#endregion
		...
		private static extern SteamAPICall_t _SteamAPI_ISteamUserStats_RequestGlobalAchievementPercentages( IntPtr self );
		#endregion
		...
		private static extern int _SteamAPI_ISteamUserStats_GetMostAchievedAchievementInfo( IntPtr self, IntPtr pchName, uint unNameBufLen, ref float pflPercent, [ MarshalAs( UnmanagedType.U1 ) ] ref bool pbAchieved );
		#endregion
		...
		private static extern int _SteamAPI_ISteamUserStats_GetNextMostAchievedAchievementInfo( IntPtr self, int iIteratorPrevious, IntPtr pchName, uint unNameBufLen, ref float pflPercent, [ MarshalAs( UnmanagedType.U1 ) ] ref bool pbAchieved );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_GetAchievementAchievedPercent( IntPtr self, IntPtr pchName, ref float pflPercent );
		#endregion
		...
		private static extern SteamAPICall_t _SteamAPI_ISteamUserStats_RequestGlobalStats( IntPtr self, int nHistoryDays );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_GetGlobalStatInt64( IntPtr self, IntPtr pchStatName, ref long pData );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_GetGlobalStatDouble( IntPtr self, IntPtr pchStatName, ref double pData );
		#endregion
		...
		private static extern int _SteamAPI_ISteamUserStats_GetGlobalStatHistoryInt64( IntPtr self, IntPtr pchStatName, long* pData, uint cubData );
		#endregion
		...
		private static extern int _SteamAPI_ISteamUserStats_GetGlobalStatHistoryDouble( IntPtr self, IntPtr pchStatName, double* pData, uint cubData );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_GetAchievementProgressLimitsInt32( IntPtr self, IntPtr pchName, ref int pnMinProgress, ref int pnMaxProgress );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamUserStats_GetAchievementProgressLimitsFloat( IntPtr self, IntPtr pchName, ref float pfMinProgress, ref float pfMaxProgress );
		#endregion
