...
namespace Steamworks
{
	internal unsafe partial struct ISteamClient
	{
		...
		private static extern HSteamPipe _SteamAPI_ISteamClient_CreateSteamPipe( IntPtr self );
		#endregion
		...
		private static extern bool _SteamAPI_ISteamClient_BReleaseSteamPipe( IntPtr self, HSteamPipe hSteamPipe );
		#endregion
		...
		private static extern HSteamUser _SteamAPI_ISteamClient_ConnectToGlobalUser( IntPtr self, HSteamPipe hSteamPipe );
		#endregion
		...
		private static extern HSteamUser _SteamAPI_ISteamClient_CreateLocalUser( IntPtr self, ref HSteamPipe phSteamPipe, EAccountType eAccountType );
		#endregion
		...
		private static extern void _SteamAPI_ISteamClient_ReleaseUser( IntPtr self, HSteamPipe hSteamPipe, HSteamUser hUser );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamUser( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamGameServer( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern void _SteamAPI_ISteamClient_SetLocalIPBinding( IntPtr self, ref SteamIPAddress_t unIP, ushort usPort );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamFriends( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamUtils( IntPtr self, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamMatchmaking( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamMatchmakingServers( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamGenericInterface( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamUserStats( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamGameServerStats( IntPtr self, HSteamUser hSteamuser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamApps( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamNetworking( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamRemoteStorage( IntPtr self, HSteamUser hSteamuser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamScreenshots( IntPtr self, HSteamUser hSteamuser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamGameSearch( IntPtr self, HSteamUser hSteamuser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern uint _SteamAPI_ISteamClient_GetIPCCallCount( IntPtr self );
		#endregion
		...
		private static extern void _SteamAPI_ISteamClient_SetWarningMessageHook( IntPtr self, IntPtr pFunction );
		#endregion
		...
		[ return: MarshalAs( UnmanagedType.I1 ) ]
		private static extern bool _SteamAPI_ISteamClient_BShutdownIfAllPipesClosed( IntPtr self );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamHTTP( IntPtr self, HSteamUser hSteamuser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamController( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamUGC( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamMusic( IntPtr self, HSteamUser hSteamuser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamMusicRemote( IntPtr self, HSteamUser hSteamuser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamHTMLSurface( IntPtr self, HSteamUser hSteamuser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamInventory( IntPtr self, HSteamUser hSteamuser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamVideo( IntPtr self, HSteamUser hSteamuser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamParentalSettings( IntPtr self, HSteamUser hSteamuser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamInput( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamParties( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
		...
		private static extern IntPtr _SteamAPI_ISteamClient_GetISteamRemotePlay( IntPtr self, HSteamUser hSteamUser, HSteamPipe hSteamPipe, IntPtr pchVersion );
		#endregion
