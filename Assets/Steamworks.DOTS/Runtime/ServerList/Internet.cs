...
{
    public struct Internet : IComponentData
    {
    ...
    internal partial struct RequestInternetServerSystem : ISystem
    {
        ...
        public void OnCreate( ref SystemState state )
        {
            var builder = new EntityQueryBuilder( Allocator.Temp )
                .WithPresent<Request, MatchMakingKeyValuePair, ResponsiveServerInfo, Internet, Refreshed>()
        ...
        private partial struct LaunchQueryJob : IJobEntity
        {
            ...
            private void Execute( in Entity entity, [ ChunkIndexInQuery ] int chunkIndex, in Request request, in Internet internet, EnabledRefRW<Refreshed> refreshed, in DynamicBuffer<MatchMakingKeyValuePair> pairs )
            {
                ...
                var hServerListRequest = steamMatchmakingServers.Internal.RequestInternetServerList( request.AppId, serverFilters.Pointer, ( uint ) serverFilters.Count, IntPtr.Zero );
