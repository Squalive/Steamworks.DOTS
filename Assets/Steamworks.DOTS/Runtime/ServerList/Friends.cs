...
{
    public struct Friends : IComponentData
    {
    ...
    internal partial struct RequestFriendsServerSystem : ISystem
    {
        ...
        public void OnCreate( ref SystemState state )
        {
            var builder = new EntityQueryBuilder( Allocator.Temp )
                .WithPresent<Request, MatchMakingKeyValuePair, ResponsiveServerInfo, Friends, Refreshed>()
        ...
        private partial struct LaunchQueryJob : IJobEntity
        {
            ...
            private void Execute( in Entity entity, [ ChunkIndexInQuery ] int chunkIndex, in Request request, in Friends friends, EnabledRefRW<Refreshed> refreshed, in DynamicBuffer<MatchMakingKeyValuePair> pairs )
            {
                ...
                var hServerListRequest = steamMatchmakingServers.Internal.RequestFriendsServerList( request.AppId, serverFilters.Pointer, ( uint ) serverFilters.Count, IntPtr.Zero );
